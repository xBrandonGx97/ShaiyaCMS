<?php
   ...
   class MailSys
   {
       ...
       public static function setMailHost()
       {
       }

       public static function setMailPort()
       {
       }
       ...
       public static function addMailAddress()
       {
       }

       public static function setMessageTitle()
       {
       }

       public static function setMessageContent()
       {
       }
   }

<?php
	class Content{
		...
		function __construct($BossRecord,$GuildRanking,$Browser,$Data,$db,$GlobChat,$Dirs,$LogSys/*,$Messenger*/,$Modal,$Nav,$Paging,$Panels,$PHP,$Plugins,$Rank_DAO,$Readable,$Select,$Session,$Setting,$SQL,$Style,$Template,$User,$Jumbotron,$Carousel){

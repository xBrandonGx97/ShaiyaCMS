<?php
	class Display{
		...
		# CONSTRUCTOR
		function __construct($Content,$Data,$db/*,$Messenger*/,$GlobChat,$Nav,$Paging,$Panels,$Session,$Setting,$Style,$Template,$User){
...
#			$this->Messenger	=	$Messenger;
		...
		function UNI_HEAD_SS(){
			...
			if($this->Paging->PAGE_ZONE == "CMS"){
				# Custom CSS
				echo '<link rel="stylesheet" type="text/css" href="assets/Themes/Standard/css/theme.css" media="all"/>';
				...
				echo '<link rel="stylesheet" type="text/css" href="assets/Themes/Dark/css/style.css" media="all"/>';
				echo '<link rel="stylesheet" type="text/css" href="assets/Themes/Light/css/style.css" media="all"/>';
			...
			if($this->Paging->PAGE_INDEX === "FREE_LOOT"){
				echo '<link rel="stylesheet" href="assets/Themes/Standard/css/freerewards_common.css" type="text/css" media="all" />';
			}
			if($this->Paging->PAGE_ZONE == "ACP"){
				# Data tables
		...
		function UNI_HEAD_JS(){
			...
			echo '<script src="assets/Plugins/GRBTime/js/GRBTime.js"></script>';

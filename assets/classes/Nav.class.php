	...
	class Nav{
				...
				echo '<nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark">';
					...
					echo '<div class="container">';
							echo '<ul class="navbar-nav mr-auto">';
								...
								$this->ds_nav_dropdown('Server Information','About','ABOUT','Boss Records','BOSS_RECORDS',false,false,'DropFinder','DROPFINDER','Guild Rankings','GUILD_RANK',false,false,false,false,'Terms of Service','TERMS',false,false,1,0);
								/* Dropdown Func
								...
								*/
								$this->ds_nav_dropdown('Community','Forum','community','Discord','Discord Link','News','NEWS','Patch Notes','PATCH',false,false,'PvP Rankings','PVP',false,false,false,false,false,false,1,0);
								$this->ds_nav_dropdown('Media','Gallery','GALLERY',false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,1,0);
								if($this->User->LoggedIn()){
									$this->ds_nav_dropdown('Member','Free Rewards','FREE_LOOT',false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,1,0);
								}
								/* test new paging ex
						...
						$this->SQL->_get_serverStatus('127.0.0.1','5677','5648');
						echo '</div>';
						}
						echo '<ul class="navbar-nav ml-auto">';
      							#echo '<button type="button" class="btn btn-sm btn-toggle active toggletheme" id="toggletheme" data-toggle="button" aria-pressed="true" autocomplete="on" name="dark_light"  onclick="toggleDarkLight()">';
								  /*$hour = time() + 10 * 365 * 24 * 60 * 60;
								  $toggleclass = 'btn btn-sm btn-toggle active toggletheme';
								  if($toggleclass==''){
									setcookie("toggleclass","btn btn-sm btn-toggle active toggletheme",$hour,"/",null,null,true);
								  }else{
									setcookie("toggleclass","btn btn-sm btn-toggle toggletheme",$hour,"/",null,null,true);
								  }*/
		...
		function ds_nav_dropdown($PageCat,$PageTitle=false,$PageLink=false,$PageTitle1=false,$PageLink1=false,$PageTitle2=false,$PageLink2=false,$PageTitle3=false,$PageLink3=false,$PageTitle4=false,$PageLink4=false,$PageTitle5=false,$PageLink5=false,$PageTitle6=false,$PageLink6=false,$PageTitle7=false,$PageLink7=false,$PageTitle8=false,$PageLink8=false,$PageShow,$ReqLogin){
			echo '<li class="nav-item dropdown">';
				...
				if($PageTitle==true){
					if($PageTitle=='Forum'){
					echo '<a class="dropdown-item dropdown-item-cms" href="'.$PageLink.'"><i class="fa fa-chevron-right"></i> '.$PageTitle.'</a>';
				}
				else{

	...
	class Paging{
		...
		function LaunchPageLoader(){
			...
			$_SESSION["RequestedPage"] = $this->PAGE_LINK;
					...
					$array_pages = array(
						...
						'PVP'=>'assets/content/cms/community/pvp/pvp.php',
						'PVP_V2'=>'assets/content/cms/community/pvp/pvp_v2.php',
						'RANK_CONTROLLER'=>'assets/content/cms/community/pvp/rank.controller.php',
						'BOSS_RECORDS'=>'assets/content/cms/info/bossrecords.php',
						'GUILD_RANK'=>'assets/content/cms/info/guildrankings.php',
						# Community
						'NEWS'=>'assets/content/cms/community/news.php',
						'PATCH'=>'assets/content/cms/community/patchnotes.php',
						'GALLERY'=>'assets/content/cms/community/media/gallery.php',
						# Member
						'RCVR_PW'=>'assets/content/cms/member/recoverpass.php',
						'FREE_LOOT'=>'assets/content/cms/member/freeloot.php',
						# ACP
		...
		function LaunchPageInfo(){
			...
			if($this->PAGE_LINK=='NEWS'){
				$this->PAGE_ZONE 		= 'CMS';
				$this->PAGE_CAT			= 'Community';
				$this->PAGE_TITLE		= 'News';
				$this->PAGE_URI			= 'assets/content/cms/community/news.php';
			...
			if($this->PAGE_LINK=='PATCH'){
				...
				$this->PAGE_URI			= 'assets/content/cms/community/patchnotes.php';
			...
			if($this->PAGE_LINK=='PVP'){
				...
				$this->PAGE_URI			= 'assets/content/cms/community/pvp/pvp.php';
				$this->PAGE_INDEX		= 'PVP';
				$this->PAGE_SUB			= '';
			}
			if($this->PAGE_LINK=='PVP_V2'){
				...
				$this->PAGE_CAT			= 'Server Information';
				$this->PAGE_TITLE		= 'PvP Rankings';
				$this->PAGE_URI			= 'assets/content/cms/community/pvp/pvp_v2.php';
			...
			if($this->PAGE_LINK=='RANK_CONTROLLER'){
				...
				$this->PAGE_CAT			= 'Server Information';
				$this->PAGE_TITLE		= 'PvP Rankings';
				$this->PAGE_URI			= 'assets/content/cms/community/pvp/rank.controller.php';
			...
			if($this->PAGE_LINK=='GALLERY'){
				$this->PAGE_ZONE 		= 'CMS';
				$this->PAGE_CAT			= 'Community';
				$this->PAGE_TITLE		= 'Gallery';
				$this->PAGE_URI			= 'assets/content/cms/community/media/gallery.php';
				$this->PAGE_INDEX		= 'GALLERY';
				$this->PAGE_SUB			= '';
			}
			# Member
			...
			if($this->PAGE_LINK=='FREE_LOOT'){
				$this->PAGE_ZONE 		= 'CMS';
				$this->PAGE_CAT			= 'Member';
				$this->PAGE_TITLE		= 'Free Loot';
				$this->PAGE_URI			= 'assets/content/cms/member/freeloot.php';
				$this->PAGE_INDEX		= 'FREE_LOOT';
				$this->PAGE_SUB			= '';
			}
			# ACP

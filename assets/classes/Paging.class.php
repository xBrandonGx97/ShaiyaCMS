	...
	class Paging{
		...
		function LaunchPageLoader(){
			...
			$_SESSION["RequestedPage"] = $this->PAGE_LINK;
					...
					$array_pages = array(
						...
						# Session
						'REGISTER'=>'assets/content/cms/session/register.php',
						'LOGIN'=>'assets/content/cms/session/login.php',
						'LOGOUT'=>'assets/content/cms/session/logout.php',
						'SESSION_END'=>'assets/content/cms/session/c-sess.php',
						'SESSION_ENDED'=>'assets/content/cms/session/term_sess.php',
						'VALIDATE'=>'assets/content/cms/session/term_sess.php',
						# Server Info
		...
		function LaunchPageInfo(){
			...
			if($this->PAGE_LINK=='INDEX'){
				...
				$this->PAGE_URI			= 'assets/content/cms/session/login.php';
			...
			if($this->PAGE_LINK=='REGISTER'){
				...
				$this->PAGE_URI			= 'assets/content/cms/session/register.php';
				$this->PAGE_INDEX		= 'REGISTER';
				$this->PAGE_SUB			= '';
			}
			if($this->PAGE_LINK=='LOGIN'){
				$this->PAGE_ZONE 		= 'CMS';
				$this->PAGE_CAT			= 'Session';
			...
			if($this->PAGE_LINK=='LOGOUT'){
				...
				$this->PAGE_URI			= 'aassets/content/cms/session/logout.php';
				$this->PAGE_INDEX		= 'LOGOUT';
				$this->PAGE_SUB			= '';
			}
			if($this->PAGE_LINK=='SESSION_END'){
				$this->PAGE_ZONE 		= 'CMS';
				$this->PAGE_CAT			= 'Session';
				$this->PAGE_TITLE		= 'Session Ended';
				$this->PAGE_URI			= 'assets/content/cms/session/c-sess.php';
				$this->PAGE_INDEX		= 'SESSION_END';
				$this->PAGE_SUB			= '';
			}
			if($this->PAGE_LINK=='SESSION_ENDED'){
				$this->PAGE_ZONE 		= 'CMS';
				$this->PAGE_CAT			= 'Session';
				$this->PAGE_TITLE		= 'Session Ended';
				$this->PAGE_URI			= 'assets/content/cms/session/term_sess.php';
				$this->PAGE_INDEX		= 'SESSION_ENDED';
				$this->PAGE_SUB			= '';
			}

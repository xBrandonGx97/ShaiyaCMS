<?php
	...
	# Start Template
	$this->Tpl->_do_ACP_pageHeader("","",true,"6","Release Jailed toons for this account by /kicking online toon then submit the toon name here");
	...
	if (empty($UserID)) {
		...
		foreach($result5 as $Row){
			$sql6 = ("
						UPDATE ".$this->db->get_TABLE("SH_CHARDATA")." SET Map = 42,PosX = 55,PosY = 3 ,PosZ = 54 where UserUID = ?
			");
        ...
        echo '<div class="form-group">';
            echo '<a class="btn btn-sm btn-primary tac" href="?'.$this->Setting->PAGE_PREFIX.'=PLR_UNJAIL" style="margin-left:5px;">Go Back</a>';
        echo '</div>';
	}
	else{

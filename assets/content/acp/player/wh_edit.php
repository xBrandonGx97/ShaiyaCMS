<?php
	...
	# Start Template
	$this->Tpl->_do_ACP_pageHeader("","",true,"6","W.H. Items Edit");
	...
	{	
		...
		$sql = ("
					...
					FROM ".$this->db->get_TABLE("SH_USERWH")." c
	...
	elseif (isset($_POST['CNE'])) 
	{
		...
		$sql = ("
					UPDATE ".$this->db->get_TABLE("SH_USERWH")." SET ItemID = ?, Type = ?, TypeID = ?, Gem1 = ?, Gem2 = ?, Gem3 = ?, Gem4 = ?, Gem5 = ?, Gem6 = ?, Count = ?, Craftname = ? WHERE ItemUID=?
		");
		$stmt=$this->db->conn->prepare($sql);

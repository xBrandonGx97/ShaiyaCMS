<?php
	class BossRecord{
		...
		public static $MobID = array('2839','2785','2821','2803','3010','3040','3041','3042','3005','3028','3023','3015','3539','1259','3984','3836','3837','3838','768','798','3833','3834','1129','1159','934','964','835','1977','1978','871','872','901','902','1704','1804','1706','1806','1702','1802','1701','1801','1714','1814','1703','1803','1705','1805','1700','1800','1716','1816','2414','2472');
		public static $MobName;
		public static $CharName;
		public static $ActionTime;

		public static function get_Record(){
			echo '<div class="table-responsive">';
				echo '<table class="table table-dark table-striped tac">';
					echo '<thead>';
						echo '<tr class="boss-record">';
							echo '<th class="boss-record">Boss</th>';
							echo '<th class="boss-record">Killed by</th>';
							echo '<th class="boss-record">Respawns in</th>';
						echo '</tr>';
					echo '</thead>';

					$time = date("Y-m-d H:i:s.000");
					foreach(self::$MobID as $value){
						$sql = ("
										SELECT TOP 1 [MobName],[CharName],[ActionTime]
										FROM ".Database::getTable("LOG_BOSS_DEATH")."
										WHERE MobID=?
						...
						self::$MobName		=	$fet["MobName"];
						self::$CharName		=	$fet["CharName"];
						self::$ActionTime		=	$fet["ActionTime"];

							if(self::$MobName != NULL){
							...
							$nextTime = date("Y-m-d H:i:s", strtotime(self::$ActionTime.'+'.$hours.' hours'));
							if($nextTime < $time){
							...
							echo '<tbody>';
								echo '<tr>';
									echo '<td>'.self::$MobName.'</td>';
									echo '<td>'.self::$CharName.'</td>';
		...
		public static function get_Record_Plugin(){

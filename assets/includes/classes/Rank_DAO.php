...
class Rank_DAO{
	 ...
	 * @return array
	 */
	public static function getCharacterRanks($criteria = array()){
	 ...
	 * @return array
	 */
	public static function getCharacterStatData($charID){
		$query=Database::connect()->prepare("
			SELECT
			c.CharID AS [CharID],
	 ...
	 * @return array
	 */
	public static function getLastKilled($charID){
		$query=Database::connect()->prepare("
			SELECT Top 1
	 ...
	 * @return array
	 */
	public static function getLastKilledBy($charID){
		$query=Database::connect()->prepare("
			SELECT Top 1
	 ...
	 * @return array
	 */
	public static function getMostKilled($charID,$startDate = null){
		if(!$startDate){
	 ...
	 * @return array
	 */
	public static function getMostKilledBy($charID,$startDate = null){
		if(!$startDate){
			$startDate = '1970-01-01 00:00:00';
		}
		$query=Database::connect()->prepare("
	...
	public static function _get_rank_view($characterRanks){
		...
		echo '<table class="RankTable text-white table table-striped table-bordered acp_table table-dark">';
...
#				exit();
				echo '<tr>';
					echo '<td class="tac '.Data::online_status_2_text($c[11]).'" title="'.$c[11].'" style="cursor:pointer">'.$c[0].'</td>';

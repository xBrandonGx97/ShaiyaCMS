...
# Start Template
Template::doACP_Head("","",true,"6","Faction Change","Costs 200 DP");
...
#			}
			$sql27 = ("
						SELECT * FROM PS_GameData.dbo.Chars WHERE UserID=?
			");
			$stmt27=Database::connect()->prepare($sql27);
			$args27 = array($userid);
...
*/			$sql7 = ("
			...
			");
			$stmt7=Database::connect()->prepare($sql7);
...
*/			$sql8 = ("
			...
			");
			$stmt8=Database::connect()->prepare($sql8);
...
*/			$sql9 = ("
			...
			");
			$stmt9=Database::connect()->prepare($sql9);
...
*/			$sql10 = ("
			...
			");
			$stmt10=Database::connect()->prepare($sql10);
...
*/			while($data3=$stmt10->fetch()){
			...
			$sql11 = ("
						...
						WHERE UserUID=?
			");
			$stmt11=Database::connect()->prepare($sql11);
...
#			else{
			$sql12 = ("
						...
						END) WHERE UserUID=?
			");
			$stmt12=Database::connect()->prepare($sql12);
...
*/			$sql13 = ("
						...
						WHERE UserID=?
			");
			$stmt13=Database::connect()->prepare($sql13);
			$args13 = array($userid);
...
*/			$sql14 = ("
			...
			");
			$stmt14=Database::connect()->prepare($sql14);
...
*/			$sql15 = ("
						...
						WHERE CharID=?
			");
			$stmt15=Database::connect()->prepare($sql15);
...
*/			$sql16 = ("
						...
						WHERE CharID=?
			");
			$stmt16=Database::connect()->prepare($sql16);
...
*/			$sql17 = ("
			...
			");
			$stmt17=Database::connect()->prepare($sql17);
...
*/			$sql18 = ("
							...
							WHERE UserUID=?
			");
						$stmt18=Database::connect()->prepare($sql18);
...
*/							$sql19 = ("
											...
											WHERE UserUID=?
							");
							$stmt19=Database::connect()->prepare($sql19);
...
*/			$sql24 = ("
						...
						AND ItemID IN (13206,13207,13208,13203,11201,11205,11206,11204)
			");
			$stmt24=Database::connect()->prepare($sql24);
...
*/			$sql20 = ("
						...
						WHERE CharID=?
			");
			$stmt20=Database::connect()->prepare($sql20);
...
*/			$sql21 = ("
						...
						WHERE UserUID=?
			");
			$stmt21=Database::connect()->prepare($sql21);
...
*/			$sql22 = ("
						...
						WHERE UserUID=?
			");
			$stmt22=Database::connect()->prepare($sql22);
...
*/
			...
			$sql23 = ("
						SELECT * FROM PS_UserData.dbo.Users_Master WHERE UserID=?
			");
			$stmt23=Database::connect()->prepare($sql23);
			$args23 = array($userid);

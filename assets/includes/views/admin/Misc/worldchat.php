<?php
    ...
    $sql = ("
                ...
                FROM ".Database::getTable("SH_CHATLOG")." AS cl
                INNER JOIN ".Database::getTable("SH_CHARDATA")." AS c ON c.CharID = cl.CharID
	...
	#	Create DATABASE LOG
	LogSys::createLog("Viewed Global Chat Log");

	# Start Template
	Template::doACP_Head("","",false,"12","Live In-Game Chat");
                                        ...
                                        while($ChatData=$stmt->fetch()){
                                            ...
                                            if ($ChatData['Family'] == 0 || $ChatData['Family'] == 1) {
                                                ...
                                                echo '<td><a href="/acp-edit-player&char='.$ChatData['CharName'].'">'.$ChatData['CharName'].'</a></td>';

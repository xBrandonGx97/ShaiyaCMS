<?php
	...
	# Start Template
	Template::doACP_Head("","",true,"6","Jail ALL toons for this account by /kicking online toon then submit the toon name here");
	...
	foreach($result5 as $Row){
		$sql6 = ("
					UPDATE ".Database::getTable("SH_CHARDATA")." SET Map = 41,PosX = 46,PosY = 3 ,PosZ = 45 where UserUID = ?
		");
    ...
    echo '<div class="form-group">';
         echo '<a class="btn btn-sm btn-primary tac" href="/acp-jail-acc" style="margin-left:5px;">Go Back</a>';
    echo '</div>';
	}
	else {

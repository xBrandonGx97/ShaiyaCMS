...
#	$Messenger		=	new Messenger($Browser,$Setting,$User);
	...
	$Content		=	new Content($BossRecord,$GuildRanking,$Browser,$Data,$db,$GlobChat,$Dirs,$LogSys/*,$Messenger*/,$Modal,$Nav,$Paging,$Panels,$PHP,$Plugins,$Rank_DAO,$Readable,$Select,$Session,$Setting,$SQL,$Style,$Tpl,$User,$Jumbotron,$Carousel);

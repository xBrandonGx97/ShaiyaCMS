<?php if(isset($_POST['submit'])): ?>
  <?php if(empty($data['postChecks']['itemId'])): ?>
  ...
  <?php if(count($data['gift']->getErrors())==0): ?>
    ...
    <?php echo $__env->make('pages.ap.fetchApi.player.verifySendGiftAll', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php endif; ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Brandon\Documents\GitHub\Shaiya-Project-v3\resources\views/pages/ap/fetchApi/player/sendGiftAll.blade.php ENDPATH**/ ?>
        ...
        <div class="nano-content">
            <div class="nk-nav-table">
                <div class="nk-nav-row">
                    <a href="'.DOC_ROOT.'" class="nk-nav-logo">
                    ...
                    <ul class="nk-nav">'
                        <li class=" nk-drop-item">
                            ...
                            <ul class="dropdown">
                                ...
                                <li class=" ">
                                    <a href="/serverinfo/dropfinder">Boss Records</a>
                                <li class=" ">
...
</nav><?php /**PATH C:\Users\Brandon\Documents\GitHub\Shaiya-Project-v3\resources\views/partials/cms/rightNav.blade.php ENDPATH**/ ?>
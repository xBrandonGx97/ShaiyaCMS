                            ...
                            <?php if(!empty($data['item']->charId)): ?>
                              <?php if(count($data['item']->getItems()) > 0): ?>
                                <form method="post">
                                  ...
                                  <input type="hidden" name="CharID" value="<?php echo e($data['item']->charId); ?>">
                                  <p class="text-center">
...
<?php echo $__env->make('layouts.ap.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Brandon\Documents\GitHub\Shaiya-Project-v3\resources\views/pages/ap/player/itemEdit.blade.php ENDPATH**/ ?>
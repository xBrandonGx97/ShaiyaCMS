                          ...
                          <?php if(isset($_POST['submit'])): ?>
                            <?php if(!empty($data['search']->userID)): ?>
                              <?php if(count($data['search']->getData()) > 0): ?>
                                ...
                                <p class="text-center">
                                  <button type="button" onclick="window.location.href='<?php echo e($_SERVER['REQUEST_URI']); ?>'" class="btn btn-sm btn-primary" name="return">Return back to account Search</button>
                                </p>
                              <?php else: ?>

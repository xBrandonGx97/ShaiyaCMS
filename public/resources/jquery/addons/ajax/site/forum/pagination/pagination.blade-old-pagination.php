<?php
    ...
    function showPages($perPage,$prevPage,$nextPage,$page) {
            ...
            if(count($tmp) > 1) {
        	    if($page > 1) {
                    // display 'Prev' link
                    echo '<a class="nk-pagination-prev pagination_link" id="'.($page - 1).'">
                ...
                if($page <= $lastPage) {
                    // display 'Next' link
                    echo '<a class="nk-pagination-next pagination_link" id="'.($page + 1).'">
        	...
        	/*echo '<div class="nk-pagination nk-pagination-left">';
        	    ...
        	    echo '<nav>';
        	        ...
        	        for ($i=1; $i<=$total_pages; $i++) {
        	        	if($page == $i) {
                            echo '<a class="nk-pagination-current-white pagination_link" id="'.$i.'">'.$i.'</a>';
                        } else {
                            echo '<a class="pagination_link" id="'.$i.'">'.$i.'</a>';
                        }
        	        	$lastPage   =   $i;
					}
        	    echo '</nav>';

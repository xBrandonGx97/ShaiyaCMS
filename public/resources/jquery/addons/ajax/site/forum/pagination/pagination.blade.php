                ...
                <div class="mod-actions col-md-3 order-md-2 text-right">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content text-center">
                            ...
                            <a href="#" class="link-effect-4 ready close_topic" data-closed="{{$Forum->closed ? 'true' : 'false'}}" data-id="{{$topicID}}"><span class="link-effect-inner"><span class="link-effect-l"><span class="close-text1">{{$Forum->closed ? 'Open Topic' : 'Close Topic'}}</span></span><span class="link-effect-r"><span class="close-text2">{{$Forum->closed ? 'Open Topic' : 'Close Topic'}}</span></span><span class="link-effect-shade"><span class="close-text3">{{$Forum->closed ? 'Open Topic' : 'Close Topic'}}</span></span></span></a>
            ...
            <ul class="nk-forum nk-forum-topic">
                ...
                @foreach($res as $data)
                    ...
                    <li class="post{{$postID}}">
                        <div class="nk-forum-topic-author" style="width:150px !important;" id="post{{$postID}}">
                            ...
                            <div class="nk-forum-topic-author-social">
                                @if($userSocials)
                                    @foreach($Forum->isSocialsPrivate($postAuthor) as $Privacy)
                                        @if($Privacy->DisplaySocials==='Public')
                                            @foreach($userSocials as $social)
                                                @if($social->Discord)
                                                    <a href="#" class="open_discord_modal" title="{{$social->Discord}}"  data-id="{{$social->Discord}}~{{$postAuthor}}" data-target="#discord_modal" data-toggle="modal"><i class="fab fa-discord" id="{{$social->Discord}}"></i></a>
                                                @endif
                                                @if($social->Skype)
                                                    <a href="skype:{{$social->Skype}}?chat" title="{{$social->Skype}}"><i class="fab fa-skype"></i></a>
                                                @endif
                                                @if($social->Steam)
                                                    <a href="#" title="{{$social->Steam}}"><i class="fab fa-steam"></i></a>
                                                @endif
                                            @endforeach
                                        @endif
                                    @endforeach
                        ...
                        <div class="nk-forum-topic-footer">
                            ...
                            @if ($isLoggedIn==true)
                                {{--<span class="nk-forum-action-btn postNum float-left">
                                    <a href="#post{{$postID}}">#{{$postNum}}</a>
                                </span>--}}
                                @if($isUserAuthor)

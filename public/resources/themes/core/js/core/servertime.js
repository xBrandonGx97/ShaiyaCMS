...
function displaytime(currentTime){
    ...
    document.querySelector("#server_time_m").innerHTML = '<a href="#"><span class="link-effect-shade"><span>' + dateString_m + '</span></span></a>';
    document.querySelector("#server_time_d").innerHTML = '<a href="#"><span class="link-effect-shade"><span>' + dateString_d + '</span></span></a>';
    document.querySelector("#server_time_y").innerHTML = '<a href="#"><span class="link-effect-shade"><span>' + dateString_y + '</span></span></a>';
    document.querySelector("#server_date").innerHTML = '<a href="#"><span class="link-effect-shade"><span>' + timestring + '</span></span></a>';
}
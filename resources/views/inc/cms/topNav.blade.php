            ...
            <div class="nk-navbar">
                <ul class="nk-nav">
                	<li class="nk-drop-item">
                        <a href="/?lang=en" class="link-effect-4 ready"><span class="link-effect-inner"><span class="link-effect-l"><span>{{Bootstrap::getLangSwitch(LANG)}}</span></span><span class="link-effect-r"><span>{{Bootstrap::getLangSwitch(LANG)}}</span></span><span class="link-effect-shade"><span>{{Bootstrap::getLangSwitch(LANG)}}</span></span></span></a>

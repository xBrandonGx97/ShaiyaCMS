<form class="send_gift_verify" id="send_gift_verify">
  <div class="alert alert-danger">
    ...
    Are you sure you want to send <b>{{$data['gift']->getItemNameFromId($data['postChecks']['itemId'])}}</b> x<b>{{$data['postChecks']['itemCount']}}</b> to {{$data['postChecks']['char']}}?
  </div>
  <input name="CharName" type="hidden" value="{{$data['postChecks']['char']}}"/>

            ...
            <div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3">
                <div class="nk-sign-form-container" style="opacity: 1; transform: translate3d(0px, 0px, 0px);">
                    <div class="nk-sign-form-toggle h3">
                        <a href="#" class="nk-sign-form-login-toggle active">{{__("loginTab")}}</a>
                        <a href="#" class="nk-sign-form-register-toggle">{{__("registerTab")}}</a>
                    </div>
                    <div class="nk-gap-2"></div>
                    <!-- START: Login Form -->
                    <form class="nk-sign-form-login active" novalidate="novalidate">
                        <div class="error-login-new-device nk-error"></div>
                        <input class="form-control login-username" type="text" placeholder="{{__("loginUserIdPlaceholder")}}" name="UserName">
                        <div class="error-login-username nk-error"></div>
                        <div class="nk-gap-2"></div>
                        <div class="input-group">
                            <input class="form-control login-password" type="password" placeholder="{{__("loginPasswordPlaceholder")}}" id="password3" name="Password">
                        ...
                        <div class="form-check pull-left">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input login-remember" checked=""> {{__("stayLoggedInCheckbox")}}
                            </label>
                        </div>
                        <input type="hidden" name="doLogin" value="true"/>
                        <div class="clearfix login-submit-container"><button type="button" class="nk-btn nk-btn-color-white link-effect-4 pull-right login-submit ready" id="login" name="doLogin"><span class="link-effect-inner"><span class="link-effect-l"><span>{{__("loginButton")}}</span></span><span class="link-effect-r"><span>{{__("loginButton")}}</span></span><span class="link-effect-shade"><span>{{__("loginButton")}}</span></span></span></button></div>
                        <div class="error-login-submit-container nk-error error-ignore"></div>
                        <div class="nk-gap-1"></div>
                        <a class="nk-sign-form-lost-toggle pull-right" href="#">{{__("lostPassword")}}</a>
                    </form>
                    <!-- END: Login Form -->
                    ...
                    <form class="nk-sign-form-register" novalidate="novalidate">
                        <input class="form-control register-username" type="text" placeholder="{{__("userName")}}" name="Username">
                        <div class="error-register-username nk-error"></div>
                        <div class="nk-gap-2"></div>
                        <input class="form-control register-display-name" type="text" placeholder="{{__("displayName")}}" name="DisplayName">
                        <div class="error-register-display-name nk-error"></div>
                        <div class="nk-gap-2"></div>
                        <input class="form-control register-email" type="email" placeholder="{{__("emailAddress")}}" name="email">
                        <div class="error-register-email nk-error"></div>
                        <div class="nk-gap-2"></div>
                        <div class="input-group">
                            <input class="form-control register-password" type="password" placeholder="{{__("password")}}" id="password" name="Pwd">
                            <span class="input-group-append">
                                <span class="input-group-text bg-transparent border-0">
                        ...
                        <div class="nk-gap-2"></div>
                        <div class="input-group">
                            <input class="form-control register-repeat-password" type="password" placeholder="{{__("repeatPassword")}}" id="password2" name="cPassword">
                            <span class="input-group-append">
                                 <span class="input-group-text bg-transparent border-0">
                        ...
                        <div class="nk-gap-2"></div>
                        <input class="form-control register-security-answer" type="text" placeholder="{{__("securityAnswer")}}" name="SecAnswer">
                        <div class="error-register-sec-answer nk-error"></div>
                        <div class="nk-gap-2"></div>
                        <input name="Terms" id="Terms" type="radio"/>
                        <label for="Terms">{{__("iAgree")}} {{APP['title']}}'s <a href="/serverinfo/terms" target="_blank">{{__("termsOfUse")}}</a></label>
                        ...
                        <div class="clearfix register-submit-container"><button type="button" class="nk-btn nk-btn-color-white link-effect-4 pull-right register-submit ready" id="registration" name="doReg"><span class="link-effect-inner"><span class="link-effect-l"><span>{{__("registerBtn")}}</span></span><span class="link-effect-r"><span>{{__("registerBtn")}}</span></span><span class="link-effect-shade"><span>{{__("registerBtn")}}</span></span></span></button></div>

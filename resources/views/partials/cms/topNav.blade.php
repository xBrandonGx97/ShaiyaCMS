            ...
            <div class="nk-navbar">
                <ul class="nk-nav">
                	<li class="nk-drop-item">
                        <a href="/?lang={{LANG}}" class="link-effect-4 ready"><span class="link-effect-inner"><span class="link-effect-l"><span>{{lang(LANG)}}</span></span><span class="link-effect-r"><span>{{lang(LANG)}}</span></span><span class="link-effect-shade"><span>{{lang(LANG)}}</span></span></span></a>
